...
export default async function Home() {
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      {/* Structured Data for SEO – single @graph for better entity relations */}
      <script
            ...
            "@graph": [
              {
                ...
                "name": "SEORDP",
                "url": "https://seordp.net",
                "logo": "https://seordp.net/icon.svg",
                ...
                "foundingDate": "2024",
                "sameAs": ["https://twitter.com/seordp"]
              },
              {
                "@type": "WebSite",
                "name": "SEORDP",
                ...
                "publisher": { "@type": "Organization", "name": "SEORDP" },
                "potentialAction": {
                  "@type": "SearchAction",
              ...
              },
              {
                ...
                "description": "Affordable group buy access to premium SEO and digital marketing tools including Ahrefs, SEMrush, Moz Pro and 50+ other tools for freelancers, bloggers and SEO agencies.",
                "provider": { "@type": "Organization", "name": "SEORDP" },
                ...
                "hasOfferCatalog": {
                  ...
                  "itemListElement": [
                    {
                      "@type": "Offer",
                      "itemOffered": { "@type": "Service", "name": "SEO Tools Package" },
                      "price": "4.99",
                      "priceCurrency": "USD"
                    }
                  ]
                ...
                "mainEntity": [
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "SEO group buy allows users to share the cost of SEO tool subscriptions, providing access to premium tools like Ahrefs, Moz, and SEMrush at a lower price."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "When you join SEO group buy, you pool resources with other users to share the cost of SEO tools. This gives you access to high-quality tools like Ahrefs and SEMrush for less."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes, SEO group buy tools such as SEMrush and Ahrefs are regularly updated to ensure you have access to the latest features and data."
                    }
                  },
                  {
                    "@type": "Question",
              ...
              },
              {
                ...
                "url": "https://seordp.net",
                "hasPart": [
                  { "@type": "SiteNavigationElement", "name": "Home", "url": "https://seordp.net" },
                  { "@type": "SiteNavigationElement", "name": "Tools Shop", "url": "https://seordp.net/single-tools-list" },
                  { "@type": "SiteNavigationElement", "name": "Pricing Plans", "url": "https://seordp.net/pages" },
                  { "@type": "SiteNavigationElement", "name": "Products", "url": "https://seordp.net/products" },
                  { "@type": "SiteNavigationElement", "name": "Blog", "url": "https://seordp.net/blog" },
                  { "@type": "SiteNavigationElement", "name": "About Us", "url": "https://seordp.net/about-us" },
                  { "@type": "SiteNavigationElement", "name": "Contact Us", "url": "https://seordp.net/contact-us" },
                  { "@type": "SiteNavigationElement", "name": "Privacy Policy", "url": "https://seordp.net/privacy-policy-3" },
                  { "@type": "SiteNavigationElement", "name": "Terms of Service", "url": "https://seordp.net/terms-of-service" }
                ]
              }
            ]
          })
